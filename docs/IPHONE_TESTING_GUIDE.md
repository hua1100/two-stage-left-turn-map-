...
5. **測試導航按鈕**
   - 點擊「使用 Apple 地圖導航」
   - ✅ 開啟 Apple Maps App（如果想取消，直接返回）
6. **測試定位按鈕**
   - 點擊右下方的「定位」圖示（藍色圓形）
   - ✅ 地圖移動到您的當前位置（需先授權位置權限）
